...
export const bancoQuiz = [
    // --- Conceitos Básicos ---
    {
        ...
        opcoes: ["Vírus da Pólio Humana", "Papilomavírus Humano", "Vírus da Hepatite P", "Herpes Vírus Potencial"],
        resposta: "Papilomavírus Humano"
    },
    {
        pergunta: "HPV é um tipo de:",
        opcoes: ["Bactéria", "Fungo", "Vírus", "Protozoário"],
        resposta: "Vírus"
    },
    {
        pergunta: "Quantos tipos de HPV existem aproximadamente?",
        opcoes: ["Cerca de 10", "Cerca de 50", "Cerca de 200", "Apenas 1"],
        resposta: "Cerca de 200"
    },
    {
        pergunta: "A maioria das infecções por HPV em pessoas jovens:",
        opcoes: ["Sempre evoluem para câncer", "Causam sintomas imediatos", "Desaparecem sozinhas sem tratamento", "Precisam de antibióticos"],
        resposta: "Desaparecem sozinhas sem tratamento"
    },
    {
        pergunta: "O HPV é considerado uma Infecção Sexualmente Transmissível (IST)?",
        opcoes: ["Sim, uma das mais comuns", "Não, é uma doença respiratória", "Apenas em casos raros", "Apenas para homens"],
    ...
    // --- Transmissão ---
    {
        ...
        opcoes: ["Pelo ar", "Compartilhando copos", "Contato sexual", "Picada de inseto"],
        resposta: "Contato sexual"
    },
    {
        pergunta: "O uso de preservativo (camisinha) durante a relação sexual:",
        opcoes: ["Elimina 100% o risco de transmissão", "Não tem efeito sobre o HPV", "Reduz o risco, mas não elimina completamente", "Aumenta o risco de transmissão"],
    ...
    },
    {
        ...
        opcoes: ["Sim, a transmissão pode ocorrer", "Não, a transmissão só ocorre com sintomas", "Apenas se tiver febre", "Apenas se a pessoa for mulher"],
        resposta: "Sim, a transmissão pode ocorrer"
    },
    {
        pergunta: "O HPV pode ser transmitido através do sexo oral?",
        opcoes: ["Não, apenas por penetração", "Sim, pode infectar boca e garganta", "Apenas se houver sangramento", "Não há estudos sobre isso"],
        resposta: "Sim, pode infectar boca e garganta"
    },
    {
        pergunta: "É possível uma mãe transmitir HPV para o bebê durante o parto?",
        opcoes: ["Não, isso é impossível", "Sim, embora seja raro, pode acontecer", "Apenas se for parto cesárea", "Apenas se o bebê for menino"],
    ...
    // --- Doenças e Consequências ---
    {
        ...
        opcoes: ["Câncer de Pele", "Câncer de Pulmão", "Câncer de Colo do Útero", "Leucemia"],
        resposta: "Câncer de Colo do Útero"
    },
    {
        pergunta: "Além do câncer de colo do útero, o HPV também pode causar:",
        opcoes: ["Apenas verrugas genitais", "Câncer de pênis, ânus e garganta", "Gripe e resfriado", "Apendicite"],
        resposta: "Câncer de pênis, ânus e garganta"
    },
    {
        pergunta: "Qual afirmação sobre os tipos de HPV está correta?",
        opcoes: ["Todos causam verrugas e câncer", "Os tipos que causam verrugas não são os mesmos que causam câncer", "Todos os tipos evoluem para câncer", "HPV não causa verrugas"],
        resposta: "Os tipos que causam verrugas não são os mesmos que causam câncer"
    },
    {
        pergunta: "O exame preventivo ginecológico, Papanicolau, serve para:",
        opcoes: ["Detectar o vírus do HPV", "Detectar as lesões nas células causadas pelo HPV", "Curar o HPV", "Prevenir a gravidez"],
    ...
    },
    {
        ...
        opcoes: ["Não, atinge apenas mulheres", "Sim, é uma das possíveis complicações em homens", "Apenas em homens acima de 70 anos", "Não, o HPV não afeta homens"],
    ...
    },
    {
        ...
        opcoes: ["Sim, sempre", "Não, na maioria dos casos o corpo elimina o vírus", "Sim, mas apenas em mulheres", "Depende do tipo sanguíneo"],
    ...
    // --- A Vacina ---
    {
        ...
        opcoes: ["Exame Papanicolau", "Uso de preservativo", "Vacinação", "Higiene íntima"],
        resposta: "Vacinação"
    },
    {
        pergunta: "A vacina contra o HPV contém:",
        opcoes: ["Vírus vivos atenuados", "Partículas parecidas com o vírus, mas que não causam doença", "Antibióticos potentes", "Células de defesa prontas"],
    ...
    },
    {
        ...
        opcoes: ["Depois de já ter tido verrugas genitais", "Durante uma infecção ativa", "Antes do início da vida sexual", "Apenas na vida adulta"],
        resposta: "Antes do início da vida sexual"
    },
    {
        pergunta: "No SUS, a vacina do HPV é:",
        opcoes: ["Paga, mas com desconto", "Gratuita para o público-alvo", "Disponível apenas em campanhas anuais", "Importada e de difícil acesso"],
        resposta: "Gratuita para o público-alvo"
    },
    {
        pergunta: "O público-alvo prioritário da vacina no SUS é:",
        opcoes: ["Idosos acima de 60 anos", "Bebês recém-nascidos", "Meninas e meninos de 9 a 14 anos", "Adultos de 30 a 40 anos"],
        resposta: "Meninas e meninos de 9 a 14 anos"
    },
    {
        pergunta: "O esquema vacinal para adolescentes de 9 a 14 anos consiste em:",
        opcoes: ["Uma dose única", "Duas doses", "Três doses", "Quatro doses anuais"],
        resposta: "Duas doses"
    },
    {
        pergunta: "Qual o intervalo recomendado entre as doses para adolescentes?",
        opcoes: ["Uma semana", "Um mês", "Seis meses", "Um ano"],
        resposta: "Seis meses"
    },
    {
        pergunta: "Meninos devem se vacinar contra o HPV?",
        opcoes: ["Não, pois não têm colo do útero", "Sim, para se protegerem e reduzirem a circulação do vírus", "Apenas se forem ter múltiplos parceiros", "Não, a vacina não tem efeito em meninos"],
    ...
    },
    {
        ...
        opcoes: ["Sim, ela elimina o vírus do corpo", "Não, ela previne futuras infecções, mas não trata as existentes", "Sim, mas apenas os tipos que causam verrugas", "Depende do sistema imunológico"],
        resposta: "Não, ela previne futuras infecções, mas não trata as existentes"
    },
    {
        pergunta: "A vacina do HPV é segura?",
        opcoes: ["Não, há muitos riscos graves", "Sim, é aprovada por órgãos de saúde mundiais como a OMS", "Ainda está em fase de testes", "Apenas a versão paga é segura"],
    ...
    },
    {
        ...
        opcoes: ["Sim, a vacina substitui o exame", "Não, o exame continua sendo essencial para o rastreamento", "Sim, mas só depois de 10 anos", "Apenas se ela tomou as 3 doses"],
        resposta: "Não, o exame continua sendo essencial para o rastreamento"
    },
    {
        pergunta: "A vacina protege contra quantos tipos de HPV?",
        opcoes: ["Apenas 1 tipo", "Todos os 200 tipos", "Contra os 4 principais tipos (2 de verrugas, 2 de câncer)", "Apenas os tipos que causam verrugas"],
        resposta: "Contra os 4 principais tipos (2 de verrugas, 2 de câncer)"
    },
    {
        pergunta: "Um efeito colateral comum e esperado da vacina é:",
        opcoes: ["Desenvolver câncer", "Ficar infértil", "Dor e vermelhidão no local da aplicação", "Perda de memória"],
        resposta: "Dor e vermelhidão no local da aplicação"
    },
    {
        pergunta: "Pessoas que vivem com HIV/AIDS podem tomar a vacina?",
        opcoes: ["Não, é contraindicado", "Sim, e o esquema vacinal é especial com mais doses", "Sim, mas a vacina tem menos efeito", "Apenas se a carga viral estiver alta"],
        resposta: "Sim, e o esquema vacinal é especial com mais doses"
    },
    // --- Mitos ---
    {
        pergunta: "Qual destas afirmações sobre o HPV é um MITO?",
        opcoes: ["Pode causar câncer de ânus", "A vacina é a melhor prevenção", "Só se pega HPV com penetração", "Pode ser assintomático"],
        resposta: "Só se pega HPV com penetração"
    },
    {
        pergunta: "Qual destas é uma FAKE NEWS comum sobre a vacina do HPV?",
        opcoes: ["Ela previne contra o câncer de colo do útero", "É gratuita no SUS para jovens", "Ela causa infertilidade", "É recomendada para meninos e meninas"],
        resposta: "Ela causa infertilidade"
    },
    {
        pergunta: "É verdade que a vacinação incentiva o início da vida sexual?",
        opcoes: ["Sim, há estudos que comprovam", "Não, estudos mostram que não há relação entre os dois", "Apenas em meninos", "Apenas em meninas"],
        resposta: "Não, estudos mostram que não há relação entre os dois"
    },
    {
        pergunta: "O que é mais seguro?",
        opcoes: ["Pegar a doença para criar imunidade 'natural'", "Tomar a vacina, que usa partículas não infecciosas", "Não fazer nada e contar com a sorte", "Tomar chás e ervas"],
        resposta: "Tomar a vacina, que usa partículas não infecciosas"
    },
    {
        pergunta: "Qual destas afirmações sobre a raridade do HPV é verdadeira?",
        opcoes: ["É uma infecção rara, quase erradicada", "É a IST mais comum no mundo", "Só existe na América do Sul", "Afeta apenas idosos"],
        resposta: "É a IST mais comum no mundo"
    },
    {
        pergunta: "A proteção da vacina do HPV dura a vida toda?",
        opcoes: ["Não, dura apenas 1 ano", "Sim, estudos indicam proteção de longa duração", "Precisa de reforço anual", "Ninguém sabe ao certo"],
    ...
    },
    {
        ...
        opcoes: ["Sim, pois já está 100% protegida de tudo", "Não, pois o preservativo protege contra outras ISTs", "Sim, mas apenas com parceiros fixos", "Depende do resultado do Papanicolau"],
        resposta: "Não, pois o preservativo protege contra outras ISTs"
    },
    {
        pergunta: "Onde a vacina do HPV é aplicada?",
        opcoes: ["Na veia", "Na nádega", "No músculo do braço (intramuscular)", "É em gotas, via oral"],
        resposta: "No músculo do braço (intramuscular)"
    },
    {
        pergunta: "É possível tomar a vacina do HPV mesmo estando gripado ou com um resfriado leve?",
        opcoes: ["Não, é extremamente perigoso", "Sim, doenças leves sem febre não impedem a vacinação", "Apenas com autorização médica por escrito", "Não, a vacina da gripe anula o efeito"],
        resposta: "Sim, doenças leves sem febre não impedem a vacinação"
    },
    {
        pergunta: "Por que a vacinação foca em jovens de 9 a 14 anos?",
        opcoes: ["Porque a vacina só funciona nessa idade", "Porque a resposta imunológica é muito mais forte em pré-adolescentes", "Porque é a única idade em que o SUS tem verba", "Porque os jovens são mais fáceis de convencer"],
    ...
    },
    {
        ...
        opcoes: ["2 tipos", "4 tipos", "9 tipos", "20 tipos"],
        resposta: "9 tipos"
    },
    {
        pergunta: "A vacina oferecida no SUS é a:",
        opcoes: ["Bivalente (2 tipos)", "Quadrivalente (4 tipos)", "Nonavalente (9 tipos)", "Monovalente (1 tipo)"],
        resposta: "Quadrivalente (4 tipos)"
    },
    {
        pergunta: "A vacina do HPV pode ser considerada uma vacina contra o câncer?",
        opcoes: ["Não, isso é um exagero", "Sim, é a primeira vacina desenvolvida para prevenir um câncer", "Não, pois ela combate o vírus, não o câncer diretamente", "Apenas para o câncer de colo do útero"],
        resposta: "Sim, é a primeira vacina desenvolvida para prevenir um câncer"
    },
    {
        pergunta: "Qual o nome do exame que pode detectar o DNA do HPV em mulheres?",
        opcoes: ["Hemograma", "Teste de Glicemia", "Captura Híbrida ou Teste de HPV", "Ultrassonografia"],
        resposta: "Captura Híbrida ou Teste de HPV"
    },
    {
        pergunta: "Se um casal está em um relacionamento monogâmico, eles precisam se preocupar com HPV?",
        opcoes: ["Não, o risco é zero", "Sim, pois um dos parceiros pode ter o vírus de relacionamentos passados sem saber", "Apenas se um deles tiver verrugas", "Apenas se não forem casados"],
    ...
    },
    {
        ...
        opcoes: ["Cardiologista", "Dermatologista", "Ginecologista", "Ortopedista"],
        resposta: "Ginecologista"
    },
    {
        pergunta: "O tratamento para as lesões causadas pelo HPV:",
        opcoes: ["É sempre feito com antibióticos", "Não existe tratamento", "Pode incluir cauterização, ácidos ou pequenas cirurgias", "É feito com a própria vacina"],
        resposta: "Pode incluir cauterização, ácidos ou pequenas cirurgias"
    },
    {
        pergunta: "O HPV é mais perigoso para:",
        opcoes: ["Homens", "Mulheres", "Idosos", "Pessoas com sistema imunológico enfraquecido"],
    ...
    },
    {
        ...
        opcoes: ["Rápido, ocorre em poucos meses", "Lento, pode levar 10 anos ou mais", "Imediato", "Que depende da alimentação"],
        resposta: "Lento, pode levar 10 anos ou mais"
    },
    {
        pergunta: "O que a vacina do HPV faz no corpo?",
        opcoes: ["Mata o vírus diretamente", "Cria uma barreira física", "Ensina o sistema imune a criar anticorpos", "Muda o DNA da pessoa"],
